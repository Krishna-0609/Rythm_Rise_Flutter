...
class TamilMelodySong extends StatefulWidget {
  const TamilMelodySong({super.key});

  @override
  State<TamilMelodySong> createState() => _TamilMelodySongState();
}

class _TamilMelodySongState extends State<TamilMelodySong> {
  ...
  Future<void> fetchSongs() async {
    try {
      final response = await fetchAllSongs(supabase, 'melody');
