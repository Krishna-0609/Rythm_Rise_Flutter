...
class TamilNewSong extends StatefulWidget {
  const TamilNewSong({super.key});

  @override
  State<TamilNewSong> createState() => _TamilNewSongState();
}

class _TamilNewSongState extends State<TamilNewSong> {
  ...
  Future<void> fetchSongs() async {
    try {
      final response = await fetchAllSongs(supabase, 'tamil_new_song');
